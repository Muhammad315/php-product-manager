...
<body>
    ...
    <div class="container my-5">
        <a href="/crud/product/create.php" class="btn btn-primary">Add Product</a><br>
                ...
                <?php
                    ...
                    while($row = $result->fetch_assoc()){
                        ...
                        <tr>
                            ...
                            <td>
                                <a class='btn btn-primary btn-sm' href='/crud/product/edit.php?id=$row[id]'>Edit</a>
                                <a class='btn btn-primary btn-sm' href='/crud/product/delete.php?id=$row[id]'>Delete</a>
                            </td>
                        </tr>
                        ";
                    }
